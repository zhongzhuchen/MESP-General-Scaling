...
n=length(C);
folder = 'old_Results';
baseFileName = strcat('data_mix',int2str(n),'_single_new.xlsx');
...
for repeattime = 1:totaltimes
    ...
    for s=865:20:945
        ...
        if repeattime ==1
            ...
            optgammas(end+1)=gamma;
        else
            gamma=optgammas((s-845)/20);
        end
%         gamma=optgammas(s/20);
        ...
        info_DDFact_comp.exitflag=nan;
        info_DDFact_comp.dualbound=nan;
        info_DDFact_comp.integrality_gap=nan;
        info_DDFact_comp.continuous_dualgap=nan;
        info_DDFact_comp.fixnum_to0=nan;
        info_DDFact_comp.fixnum_to1=nan;
        info_DDFact_comp.fixnum=nan;
        info_DDFact_comp.alpha=nan;
        info_DDFact_comp.time=nan;
        info_DDFact_comp.cputime=nan;
