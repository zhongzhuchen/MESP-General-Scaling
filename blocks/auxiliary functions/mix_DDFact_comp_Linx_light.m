function [fval,x,info] = mix_DDFact_comp_Linx_light(x0,C,s,F_comp,Fsquare_comp,ldetC,A_data,b_data,Gamma1,Gamma2)
n=length(C);
info=struct;
...
[~, xa, ~] = Knitro_DDFact_comp_light(x0,C,s,F_comp,Fsquare_comp,ldetC,A_data,b_data,Gamma1);
[~, xb, ~] = Knitro_Linx_light(x0,C,s,A_data,b_data,Gamma2);
[fval_a1, dx_a1, info_a1] = DDFact_comp_obj_Knitro(xa,s,F_comp,Fsquare_comp,ldetC,Gamma1);
[fval_a2, dx_a2, info_a2] = Linx_obj_Knitro(xa,C,Gamma2);
[fval_b1, dx_b1, info_b1] = DDFact_comp_obj_Knitro(xb,s,F_comp,Fsquare_comp,ldetC,Gamma1);
...
elseif dalpha_b <=0
    ...
    options = knitro_options('algorithm', 3, 'convex', 1, 'derivcheck', 0, 'outlev', 0 , 'gradopt', 1, ...
                             ...
                             'bar_maxcrossit', 10);
    alpha=1/2;
    obj_fn = @(x) mix_DDFact_comp_Linx_obj_Knitro(x,C,s,F_comp,Fsquare_comp,ldetC,Gamma1,Gamma2,alpha);
