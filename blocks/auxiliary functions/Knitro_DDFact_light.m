function [fval,x,info]=Knitro_DDFact_light(x0,C,s,F,Fsquare,A,b,Gamma, param)
%% obtain problem data 
n = length(x0);
A_data=A;
b_data=b;
...
options = knitro_options('algorithm', param.algorithm, 'convex', 1, 'derivcheck', 0, 'outlev', 1 , 'gradopt', 1, ...
