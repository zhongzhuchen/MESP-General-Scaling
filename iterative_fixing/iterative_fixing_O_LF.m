diary osclaing_iterfix_Gammaitr1_gammaitr10;
...
%         [optGamma,info_Linxg2]= MESPInstance.BFGS_Linx_Gamma(s, sqrt(optgamma)*ones(n,1), timelimit);
...
%         [fval,x,info_cFact] = MESPInstance.Knitro_DDFact_comp(x0,s,ones(n,1));
        if isempty(info_Linx.fixto0list) && isempty(info_Linx.fixto1list) && ...
            ...
            fprintf("Before fixing, Linx intgap is %f, DDFact intgap is %f. \n", ...
                info_Linx.integrality_gap, info_Fact.integrality_gap);
            if info_Linx.integrality_gap < 1e-6 || info_Fact.integrality_gap < 1e-6 
...
if Corder == 63
    fixnumsnew.oscaling_63 = gscaling_list;
elseif Corder == 90
    fixnumsnew.oscaling_90 = gscaling_list;
elseif Corder == 124
    fixnumsnew.oscaling_124 = gscaling_list;
elseif Corder == 150
    fixnumsnew.oscaling_150 = gscaling_list;
elseif Corder == 300
    fixnumsnew.oscaling_300 = gscaling_list;
end
% fix=fix63;
