diary osclaing_iterfix_Gammaitr1;
...
for outs= 80:120 %2:(Corder-1)
    ...
    scaling_list(end+1)=min(Corder, length(allfix0)+length(allfix1));
...
if Corder == 63
    fixnumsnew.oscaling_63 = scaling_list;
elseif Corder == 90
    fixnumsnew.oscaling_90 = scaling_list;
elseif Corder == 124
    fixnumsnew.oscaling_124 = scaling_list;
elseif Corder == 150
    fixnumsnew.oscaling_150 = scaling_list;
elseif Corder == 300
    fixnumsnew.oscaling_300 = scaling_list;
end
% fix=fix63;
% filename = strcat('iterative_fixing/fix', num2str(Corder), '_LFcF_oscaling.mat');
% save(filename,'fix');
diary off;
